...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Anime Scaled Figure Store v3`}</title>

        <meta
          name="description"
          content="Welcome to Anime Scaled Figure Store v3 - your hub for managing collections, making purchases, and discussing the latest releases. A place where collectors meet analytics."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1519638399535-1b036603ac77?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhbmltZXxlbnwwfHx8fDE2OTM2NTY4Mjh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Anime Scaled Figure Store v3`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Anime Scaled Figure Store v3 - your hub for managing collections, making purchases, and discussing the latest releases. A place where collectors meet analytics.`}
            </Text>
            <Box
